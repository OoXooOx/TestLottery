...
interface IERC20 {
    event Transfer(address indexed from, address indexed to, uint256 value, uint256 rewards);
...
contract Test is ERC20, ERC20Permit {
    ...
    constructor() ERC20("Test", "TST") ERC20Permit("Test") {
        _mint(_msgSender(), maxSupply*5/100); 
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        require(from != address(0), "ERC20: transfer from the zero address");
        require(to != address(0), "ERC20: transfer to the zero address");
        uint rewards = getRewardsForTime();
        lastTransfer = block.timestamp;
        _beforeTokenTransfer(from, to, amount);
        ...
        emit Transfer(from, to, amount, rewards);
        _afterTokenTransfer(from, to, amount);
    }
